...
> **⚠️ 历史快照（非当前发布证据）**
>
> 本文档是 2025-01-11 针对 empyrical v0.6.0 的历史索引快照，其函数签名、
> 计数与行为描述**不是** fincore 0.3.0 的验收证据。正文未作改写，仅作存档。
>
> 当前证据请使用：
> - 兼容矩阵与冻结清单：[compatibility/empyrical-0.6.0.md](compatibility/empyrical-0.6.0.md)、
>   [`tests/compat/fixtures/empyrical-0.6.0-api.json`](../tests/compat/fixtures/empyrical-0.6.0-api.json)
> - 可执行门禁：`tests/compat/`（CI job `compat`）
> - 当前 API 参考：https://cloudquant.github.io/fincore/api/fincore/
> - 快照索引：[迭代计划/README.md](迭代计划/README.md)
