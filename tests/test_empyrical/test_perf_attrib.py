...
class PerfAttribTestCase(unittest.TestCase):
    def test_perf_attrib_simple(self):
        ...
        positions = pd.Series(
            [0.2857142857142857, 0.7142857142857143, 0.2857142857142857, 0.7142857142857143], index=index
        )
        ...
        self.assertTrue(expected_perf_attrib_output.round(10).equals(perf_attrib_output.round(10)))
    ...
    def test_perf_attrib_regression(self):
        ...
        pd.testing.assert_series_equal(expected_common_returns, common_returns, check_names=False)
