...
class TestStatisticalProperties(TestCase):
    ...
    def test_skewness_positive(self):
        ...
        emp = Empyrical()
        result = emp.skewness(self.positive_skew_returns)
    ...
    def test_kurtosis_empty(self):
        """Test that empty returns give NaN."""
        emp = Empyrical()
        result = emp.kurtosis(self.empty_returns)
        assert np.isnan(result)
    ...
    def test_hurst_exponent_trending(self):
        ...
        emp = Empyrical()
        result = emp.hurst_exponent(self.trending_returns)
    ...
    def test_hurst_exponent_mean_reverting(self):
        ...
        emp = Empyrical()
        result = emp.hurst_exponent(self.mean_reverting_returns)
    ...
    def test_hurst_exponent_random(self):
        ...
        emp = Empyrical()
        result = emp.hurst_exponent(self.random_returns)
    ...
    def test_hurst_exponent_empty(self):
        """Test that empty returns give NaN."""
        emp = Empyrical()
        result = emp.hurst_exponent(self.empty_returns)
        assert np.isnan(result)
