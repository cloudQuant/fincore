...
class TestPerfAttribWarnings(unittest.TestCase):
    ...
    def test_missing_stocks_and_dates(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            raw_perf_attrib(returns, positions, factor_returns, factor_loadings_missing_stocks)
            ...
            exposures, perf_attrib_data = raw_perf_attrib(
                returns, positions, factor_returns, factor_loadings_missing_dates
            )
            ...
            exposures, perf_attrib_data = raw_perf_attrib(
                returns, positions, factor_returns, factor_loadings_missing_both
            )
            ...
            with self.assertRaisesRegex(ValueError, "No factor loadings were available"):
                exposures, perf_attrib_data = raw_perf_attrib(returns, positions, factor_returns, empty_factor_loadings)
