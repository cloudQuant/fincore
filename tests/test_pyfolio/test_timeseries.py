...
from fincore.utils.common_utils import to_utc, to_series, get_month_end_freq
import gzip
...
class TestDrawdown(TestCase):
    ...
    def test_drawdown_overlaps(self):
        ...
        spy_drawdowns = Empyrical.gen_drawdown_table(
            spy_returns,
...
class TestStats(TestCase):
    ...
    def test_sharpe_2(self, returns, rolling_sharpe_window, expected):
        ...
        result = Empyrical.rolling_sharpe(returns,
...
class TestGrossLev(TestCase):
    ...
    def test_gross_lev_calculation(self):
        assert_series_equal(
            Empyrical.gross_lev(self.test_pos)['2004-02-01':],
