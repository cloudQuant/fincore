...
class PerfAttribTestCase(unittest.TestCase):
    ...
    def test_perf_attrib_regression(self):
        positions = pd.read_csv(self.__location__ + "/test_data/positions.csv", index_col=0, parse_dates=True)
        ...
        returns = pd.read_csv(self.__location__ + "/test_data/returns.csv", index_col=0, parse_dates=True, header=None)
        returns = returns.squeeze()  # Manually squeeze if needed
        factor_loadings = pd.read_csv(self.__location__ + "/test_data/factor_loadings.csv", index_col=[0, 1])
        ...
        factor_returns = pd.read_csv(self.__location__ + "/test_data/factor_returns.csv", index_col=0, parse_dates=True)

        residuals = pd.read_csv(self.__location__ + "/test_data/residuals.csv", index_col=0, parse_dates=True)

        residuals.columns = [int(col) for col in residuals.columns]

        intercepts = pd.read_csv(self.__location__ + "/test_data/intercepts.csv", index_col=0, header=None)
