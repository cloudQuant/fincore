...
class TestContinuousStats(TestCase):
    ...
    def test_max_consecutive_down_months(self):
        emp = Empyrical()
        result = emp.max_consecutive_down_months(self.monthly_returns)
