...
class TestAdvancedRatios(TestCase):
    ...
    def test_sterling_ratio(self):
        ...
        result = empyrical.sterling_ratio(self.returns_with_drawdown)
    ...
    def test_sterling_ratio_positive_returns(self):
        ...
        result = empyrical.sterling_ratio(self.positive_returns)
    ...
    def test_sterling_ratio_empty(self):
        ...
        result = empyrical.sterling_ratio(self.empty_returns)
        assert np.isnan(result)

    # Test Burke Ratio
    def test_burke_ratio(self):
        """Test Burke ratio calculation."""
        result = empyrical.burke_ratio(self.returns_with_drawdown)
    ...
    def test_burke_ratio_positive_returns(self):
        ...
        result = empyrical.burke_ratio(self.positive_returns)
        assert result > 0, f"Expected positive Burke ratio, got {result}"

    def test_burke_ratio_empty(self):
        """Test that empty returns give NaN."""
        result = empyrical.burke_ratio(self.empty_returns)
        assert np.isnan(result)

    # Test Kappa 3 Ratio
    def test_kappa_three_ratio(self):
        """Test Kappa 3 ratio calculation."""
        result = empyrical.kappa_three_ratio(self.returns_with_drawdown)
    ...
    def test_adjusted_sharpe_ratio_vs_regular(self):
        ...
        adjusted = empyrical.adjusted_sharpe_ratio(self.normal_returns)
        regular = empyrical.sharpe_ratio(self.normal_returns)
    ...
    def test_adjusted_sharpe_ratio_empty(self):
        """Test that empty returns give NaN."""
        result = empyrical.adjusted_sharpe_ratio(self.empty_returns)
        assert np.isnan(result)

    # Test Stutzer Index
    def test_stutzer_index(self):
        """Test Stutzer index calculation."""
        result = empyrical.stutzer_index(self.normal_returns)
