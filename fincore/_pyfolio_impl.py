...
__all__ = ["DisplayFunc", "MarkdownFunc", "Pyfolio", "run_workflow"]
...
def run_workflow(public_name: str, arguments: dict[str, Any]) -> Any:
    """Run one public workflow through the stateful class implementation."""

    instance = Pyfolio(set_context=False)
    method = getattr(instance, public_name)
