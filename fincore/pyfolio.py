...
class Pyfolio(Empyrical):
    ...
    def plot_best(self, trace=None, data_train=None, data_test=None,
        ...
        """
        return _plot_best(self, trace=trace, data_train=data_train, data_test=data_test,
                          samples=samples, burn=burn, axs=axs)
    ...
    def _plot_bayes_cone(self, returns_train, returns_test,
        ...
        """
        return __plot_bayes_cone(self, returns_train, returns_test, preds,
                                 plot_train_len=plot_train_len, ax=ax)
    ...
    def plot_bayes_cone(self, returns_train, returns_test, ppc,
        ...
        """
        return _plot_bayes_cone(self, returns_train, returns_test, ppc,
                                plot_train_len=plot_train_len, ax=ax)
    ...
    def plot_sector_exposures_longshort(self, long_exposures, short_exposures,
        ...
        """
        return _plot_sector_exposures_longshort(long_exposures, short_exposures,
                                                sector_dict=sector_dict, ax=ax)
    ...
    def create_full_tear_sheet(self, returns, positions=None, transactions=None,
                               ...
                               round_trips=False, estimate_intraday='infer', hide_positions=False,
                               cone_std=(1.0, 1.5, 2.0), bootstrap=False, unadjusted_returns=None,
                               style_factor_panel=None, sectors=None, caps=None, shares_held=None,
                               volumes=None, percentile=None, turnover_denom='AGB', set_context=True,
        ...
        return _create_full_tear_sheet(
            self, returns, positions=positions, transactions=transactions,
            market_data=market_data, benchmark_rets=benchmark_rets, slippage=slippage,
            live_start_date=live_start_date, sector_mappings=sector_mappings, bayesian=bayesian,
            round_trips=round_trips, estimate_intraday=estimate_intraday, hide_positions=hide_positions,
            cone_std=cone_std, bootstrap=bootstrap, unadjusted_returns=unadjusted_returns,
            style_factor_panel=style_factor_panel, sectors=sectors, caps=caps, shares_held=shares_held,
            volumes=volumes, percentile=percentile, turnover_denom=turnover_denom, set_context=set_context,
            factor_returns=factor_returns, factor_loadings=factor_loadings, pos_in_dollars=pos_in_dollars,
            header_rows=header_rows, factor_partitions=factor_partitions
        )

    @customize
    def create_simple_tear_sheet(self, returns, positions=None, transactions=None,
                                 benchmark_rets=None, slippage=None, estimate_intraday='infer',
                                 live_start_date=None, turnover_denom='AGB', header_rows=None):
        """
        ...
        return _create_simple_tear_sheet(
            self, returns, positions=positions, transactions=transactions,
            benchmark_rets=benchmark_rets, slippage=slippage, estimate_intraday=estimate_intraday,
            live_start_date=live_start_date, turnover_denom=turnover_denom, header_rows=header_rows
        )

    @customize
    def create_returns_tear_sheet(self, returns, positions=None, transactions=None,
                                  live_start_date=None, cone_std=(1.0, 1.5, 2.0),
                                  benchmark_rets=None, bootstrap=False, turnover_denom='AGB',
                                  header_rows=None, run_flask_app=False):
        """
        ...
        return _create_returns_tear_sheet(
            self, returns, positions=positions, transactions=transactions,
            live_start_date=live_start_date, cone_std=cone_std, benchmark_rets=benchmark_rets,
            bootstrap=bootstrap, turnover_denom=turnover_denom, header_rows=header_rows,
            run_flask_app=run_flask_app
        )

    @customize
    def create_position_tear_sheet(self, returns, positions, show_and_plot_top_pos=2,
                                   hide_positions=False, run_flask_app=False,
        ...
        return _create_position_tear_sheet(
            self, returns, positions, show_and_plot_top_pos=show_and_plot_top_pos,
            hide_positions=hide_positions, run_flask_app=run_flask_app,
            sector_mappings=sector_mappings, transactions=transactions,
    ...
    def create_txn_tear_sheet(self, returns, positions, transactions,
        ...
        return _create_txn_tear_sheet(
            self, returns, positions, transactions,
            unadjusted_returns=unadjusted_returns, estimate_intraday=estimate_intraday,
            run_flask_app=run_flask_app
        )
    ...
    def create_round_trip_tear_sheet(self, returns, positions, transactions,
        ...
        return _create_round_trip_tear_sheet(
            self, returns, positions, transactions,
            sector_mappings=sector_mappings, estimate_intraday=estimate_intraday,
            run_flask_app=run_flask_app
        )

    @customize
    def create_interesting_times_tear_sheet(self, returns, benchmark_rets=None,
                                            legend_loc='best', run_flask_app=False):
        """
        ...
        return _create_interesting_times_tear_sheet(
            self, returns, benchmark_rets=benchmark_rets,
            legend_loc=legend_loc, run_flask_app=run_flask_app
        )

    @customize
    def create_capacity_tear_sheet(self, returns, positions, transactions, market_data,
                                   liquidation_daily_vol_limit=0.2, trade_daily_vol_limit=0.05,
                                   last_n_days=APPROX_BDAYS_PER_MONTH * 6, days_to_liquidate_limit=1,
        ...
        return _create_capacity_tear_sheet(
            self, returns, positions, transactions, market_data,
            liquidation_daily_vol_limit=liquidation_daily_vol_limit,
            trade_daily_vol_limit=trade_daily_vol_limit, last_n_days=last_n_days,
            days_to_liquidate_limit=days_to_liquidate_limit,
            estimate_intraday=estimate_intraday, run_flask_app=run_flask_app
        )
    ...
    def create_bayesian_tear_sheet(self, returns, benchmark_rets=None,
        ...
        return _create_bayesian_tear_sheet(
            self, returns, benchmark_rets=benchmark_rets,
            live_start_date=live_start_date, samples=samples,
            run_flask_app=run_flask_app, stoch_vol=stoch_vol, progressbar=progressbar
        )

    @customize
    def create_risk_tear_sheet(self, positions, style_factor_panel=None,
                               sectors=None, caps=None, shares_held=None,
                               volumes=None, percentile=None, returns=None,
        ...
        return _create_risk_tear_sheet(
            self, positions, style_factor_panel=style_factor_panel,
            sectors=sectors, caps=caps, shares_held=shares_held,
            volumes=volumes, percentile=percentile, returns=returns,
            transactions=transactions, estimate_intraday=estimate_intraday,
            run_flask_app=run_flask_app
        )

    @customize
    def create_perf_attrib_tear_sheet(self, returns, positions, factor_returns,
                                      factor_loadings, transactions=None,
                                      pos_in_dollars=True, run_flask_app=False,
        ...
        return _create_perf_attrib_tear_sheet(
            self, returns, positions, factor_returns, factor_loadings,
            transactions=transactions, pos_in_dollars=pos_in_dollars,
            run_flask_app=run_flask_app, factor_partitions=factor_partitions
        )
    ...
    def show_perf_stats(self, returns, factor_returns=None, positions=None,
        ...
        return _show_perf_stats(
            self, returns, factor_returns=factor_returns, positions=positions,
            transactions=transactions, turnover_denom=turnover_denom,
            live_start_date=live_start_date, bootstrap=bootstrap,
            header_rows=header_rows, run_flask_app=run_flask_app
        )
    ...
    def plot_rolling_returns(self, returns, factor_returns=None, live_start_date=None,
                             logy=False, cone_std=None, legend_loc='best',
                             volatility_match=False, cone_function=None, ax=None, **kwargs):
        """
        ...
        return _plot_rolling_returns(
            self, returns, factor_returns=factor_returns, live_start_date=live_start_date,
            logy=logy, cone_std=cone_std, legend_loc=legend_loc,
            volatility_match=volatility_match, cone_function=cone_function, ax=ax, **kwargs
        )
    ...
    def plot_rolling_volatility(self, returns, factor_returns=None,
                                rolling_window=None, legend_loc='best', ax=None, **kwargs):
        """
        Plots rolling volatility.
        See fincore.tearsheets.returns.plot_rolling_volatility for full documentation.
        """
        return _plot_rolling_volatility(self, returns, factor_returns=factor_returns,
                                        rolling_window=rolling_window, legend_loc=legend_loc, ax=ax, **kwargs)
    ...
    def plot_rolling_sharpe(self, returns, factor_returns=None,
        ...
        """
        return _plot_rolling_sharpe(self, returns, factor_returns=factor_returns,
                                    rolling_window=rolling_window, legend_loc=legend_loc, ax=ax, **kwargs)
    ...
    def show_and_plot_top_positions(self, returns, positions_alloc,
        ...
        return _show_and_plot_top_positions(
            self, returns, positions_alloc, show_and_plot=show_and_plot,
            hide_positions=hide_positions, legend_loc=legend_loc, ax=ax,
            run_flask_app=run_flask_app, **kwargs
        )
    ...
    def plot_slippage_sweep(self, returns, positions, transactions,
        ...
        """
        return _plot_slippage_sweep(self, returns, positions, transactions,
                                    slippage_params=slippage_params, ax=ax, **_kwargs)
    ...
    def plot_capacity_sweep(self, returns, transactions, market_data,
                            bt_starting_capital, min_pv=100000,
                            max_pv=300000000, step_size=1000000, ax=None):
        """
        ...
        return _plot_capacity_sweep(
            self, returns, transactions, market_data, bt_starting_capital,
            min_pv=min_pv, max_pv=max_pv, step_size=step_size, ax=ax
        )
    ...
    def plot_cones(self, name, bounds, oos_returns, _num_samples=1000, ax=None,
        ...
        """
        return _plot_cones(
            self, name, bounds, oos_returns, _num_samples=_num_samples,
            ax=ax, cone_std=cone_std, _random_seed=_random_seed, num_strikes=num_strikes
        )
    ...
    def show_perf_attrib_stats(self, returns, positions, factor_returns,
                               factor_loadings, transactions=None, pos_in_dollars=True):
        """
    ...
    def plot_factor_contribution_to_perf(self, perf_attrib_data, ax=None,
